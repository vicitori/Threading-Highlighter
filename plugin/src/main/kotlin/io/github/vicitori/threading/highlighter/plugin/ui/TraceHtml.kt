...
object TraceHtml {
    ...
    fun summary(
        ...
        body.append(
            HtmlChunk.tag("div").style("color:#808080").children(
    ...
    fun details(
        ...
        body.append(
            HtmlChunk.tag("div").style("color:#808080").children(
                ...
                HtmlChunk.tag("b").addText(lineNumber.toString()),
            ),
        )
        if (stale) {
            body.append(
                HtmlChunk.tag("div").style("color:#C8783C;margin-top:4px").addText(
        ...
        records.forEachIndexed { index, (marker, trace) ->
            ...
            block.append(
                HtmlChunk.tag("div").style("margin-top:4px").children(
            ...
            block.append(
                HtmlChunk.tag("div").style("color:#808080;margin-top:2px").addText(
    ...
    private fun page(body: HtmlBuilder): String = HtmlChunk.html().child(HtmlChunk.body().child(body.toFragment())).toString()
}
